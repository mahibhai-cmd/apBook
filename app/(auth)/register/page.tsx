...
export const metadata: Metadata = {
  ...
  keywords: 'APBook register, apbook.in signup, betting exchange registration India, online betting account India',
  alternates: { canonical: 'https://www.apbook.in/register' },
